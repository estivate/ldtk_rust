...
LDtk is a 2d level editor for games that supports multiple tyle layers, placement rules
and more.

This library parses the JSON format created by LDtk so it can be used in Rust. It
provides typed access to the values so you get all the benefits, including auto 
